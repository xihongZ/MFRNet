...
parse.add_argument('--config', dest='config', type=str,
        default='/home/hi/ZXH/BiSeNet3-29/configs/bisenetv1_city.py',)
parse.add_argument('--weight-path', dest='weight_pth', type=str,
        default='/home/hi/ZXH/BiSeNet3-29/res/bisenetv1/model_final.pth')
parse.add_argument('--outpath', dest='out_pth', type=str,
        default='/home/hi/ZXH/BiSeNet3-29/res/onnx512/model.onnx')
